<?php
class Eva_Content_Box_01 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_01';
	}
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .content-box-1-icon' => 'font-size: {{SIZE}}{{UNIT}};',
            ],
        ]
    );
    ...
    // Box Margin Section
        $this->add_control(
            ...
            [
                ...
                // ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-1' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Padding Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    // Box Border Radius Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-1' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
   ...
   <div class="content-box-1">
        ...
        <div class="content-box-1-content-wrapper">
            <h3 class="content-box-1-title"><?php echo $content_box_title; ?></h3>
            <div class="content-box-1-content"><?php echo $content_box_description; ?></div>
        </div>
        <a class="content-box-1-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
    <!-- END Content Box 1 -->
