<?php
class Eva_Content_Box_02 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_02';
	}

	public function get_title()
	{
		return esc_html__('Content Box 2', 'eva');
	}
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .content-box-2-icon' => 'font-size: {{SIZE}}{{UNIT}};',
            ],
        ]
    );
    ...
    // Content Box Border Color (1)
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-2-icon-wrapper',
            ]
        );
    ...
    // Box Margin Section
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Padding Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    // Box Border Radius Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-2' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Hover Button Animation
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-2::before' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    <div class="content-box-2">
        ...
        <div class="content-box-2-content-wrapper">
            <h3 class="content-box-2-title"><?php echo $content_box_title; ?></h3>
            <div class="content-box-2-content"><?php echo $content_box_description; ?></div>
        </div>
        <a class="content-box-2-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
    </div>
    <!-- END Content Box 2 -->
