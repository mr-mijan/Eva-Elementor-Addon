<?php
class Eva_Content_Box_04 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_04';
	}

	public function get_title()
	{
		return esc_html__('Content Box 4', 'eva');
	}
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .content-box-4-icon' => 'font-size: {{SIZE}}{{UNIT}};',
            ],
        ]
    );

    // Content Box Border Color (1)
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'border_color_01',
                'selector' => '{{WRAPPER}} .content-box-4-icon-wrapper',
            ]
        );
    ...
    // Box Margin Section
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Padding Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-4' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    // Box Border Radius Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-4' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Hover Button Animation
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-4::before' => 'background-color: {{VALUE}}',
                ],
            ]
        );
 ...
 <div class="content-box-4">
            ...
            <div class="content-box-4-content-wrapper">
                <h3 class="content-box-4-title"><?php echo $content_box_title; ?></h3>
                <div class="content-box-4-content"><?php echo $content_box_description; ?></div>
            </div>
            <a class="content-box-4-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
        <!-- END Content Box 4 -->
