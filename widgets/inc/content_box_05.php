<?php
class Eva_Content_Box_05 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_05';
	}

	public function get_title()
	{
		return esc_html__('Content Box 5', 'eva');
	}
    ...
    // Content Box 01 Icon Size
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-5-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Content Box Title Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-5-title' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Title Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-5-title',
            ]
        );
    ...
    // Content Box Description Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-5-content' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Description Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-5-content',
            ]
        );
    ...
    // Box Background Section
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-5' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    // Box Margin Section
 ...
 <div class="content-box-5">
            <div class="content-box-5-icon-wrapper">
                <div class="content-box-5-icon-box">
                    <span class="content-box-5-icon">
                        <i class="<?php echo $content_box_icon ['value'];?>"></i>
                    </span>
                </div>
            </div>
            <div class="content-box-5-content-wrapper">
                <h3 class="content-box-5-title"><?php echo $content_box_title; ?></h3>
                <div class="content-box-5-content"><?php echo $content_box_description; ?></div>
            </div>
            <a class="content-box-5-link" href="<?php echo $content_box_button_url['url']; ?>"></a>
        </div>
        <!-- END Content Box 5 -->
