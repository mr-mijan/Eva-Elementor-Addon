<?php
class Eva_Content_Box_07 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_07';
	}

	public function get_title()
	{
		return esc_html__('Content Box 7', 'eva');
	}
    ...
    // Content Box Icon Color (1)
        $this->add_control(
            ...
            [
                ...
                'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Icon Color (1)
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-icon' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .content-box-7-icon' => 'font-size: {{SIZE}}{{UNIT}};',
            ],
        ]
    );
    ...
    // Content Box Title Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-title' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Title Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-7-title',
            ]
        );
    ...
    // Content Box Description Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-content' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Description Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-7-content',
            ]
        );
    ...
    // Content Box btn Section
        ...
        [
            ...
            'selector' => '{{WRAPPER}} .content-box-7-button',
        ]
    );
    ...
    // Content Box btn Section (color)
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-button' => 'color: {{VALUE}}',
                ],
            ]
        );

    // Content Box btn Section (Background)
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Content Box btn Section (color)
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-button:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Content Box btn Section (Background)
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7-button:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Box Background Section
        $this->add_control(
            'box_background',
            [
                'label' => esc_html__( 'Hover Background Color', 'eva' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-7:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    //
    $this->add_control(
        'box_background_hover_icon',
        [
            'label' => esc_html__( 'Hover Icon Color', 'eva' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .content-box-7:hover .content-box-7-icon' => 'color: {{VALUE}}',            ],
        ]
    );

    $this->add_control(
        'box_background_hover_title',
        [
            'label' => esc_html__( 'Hover Title Color', 'eva' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .content-box-7:hover .content-box-7-title' => 'color: {{VALUE}}',            ],
        ]
    );

    $this->add_control(
        'box_background_hover_desc',
        [
            'label' => esc_html__( 'Hover Description Color', 'eva' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .content-box-7:hover .content-box-7-content' => 'color: {{VALUE}}',            ],
        ]
    );
    // Box Margin Section
        $this->add_control(
            'box_margin',
            [
                'label' => esc_html__( 'Margin', 'eva' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-7' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Padding Section
        $this->add_control(
            'box_padding',
            [
                'label' => esc_html__( 'Padding', 'eva' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-7' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    // Box Border Radius Section
        $this->add_control(
            'box_border_radius',
            [
                'label' => esc_html__( 'Border Radius', 'eva' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-7' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Shadow
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'selector' => '{{WRAPPER}} .content-box-7',
            ]
        );
 ...
 <div class="content-box-7">
        <div class="content-box-7-icon-wrapper">
            <span class="content-box-7-icon">
                <i class="<?php echo $content_box_icon ['value'];?>"></i>
            </span>
        </div>
        <div class="content-box-7-content-wrapper">
            <h3 class="content-box-7-title"><?php echo $content_box_title; ?></h3>
            <div class="content-box-7-content"><?php echo $content_box_description; ?></div>
            <a class="content-box-7-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
    </div>
        <!-- END Content Box 7 -->
