<?php
class Eva_Content_Box_08 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_08';
	}

	public function get_title()
	{
		return esc_html__('Content Box 8', 'eva');
	}
    ...
    // Content Box Icon Color (1)
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .content-box-8-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Content Box Icon BG Color (1)
        $this->add_control(
            ...
            [
                ...
                'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-8-icon-box' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Content Box 01 Icon Size
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-8-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Content Box Title Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-8-title' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Title Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-8-title',
            ]
        );
    ...
    // Content Box Description Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-8-content' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Description Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-8-content',
            ]
        );
 ...
 <div class="content-box-8">
            ...
            <div class="content-box-8-content-wrapper">
                <h3 class="content-box-8-title"><?php echo $content_box_title; ?></h3>
                <div class="content-box-8-content"><?php echo $content_box_description; ?></div>
            </div>
            <a class="content-box-8-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
        <!-- END Content Box 8 -->
