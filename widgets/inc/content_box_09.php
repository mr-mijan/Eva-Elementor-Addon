<?php
class Eva_Content_Box_09 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_09';
	}

	public function get_title()
	{
		return esc_html__('Content Box 9', 'eva');
	}
    ...
    // Content Box Icon Color (1)
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .content-box-9-icon' => 'color: {{VALUE}}',
                ],
            ]
        );

    // Content Box Icon BG Color (1)
        $this->add_control(
            'content_box_icon_BG_color',
            [
                'label' => esc_html__( 'Icon BG Color', 'eva' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-9-icon-box' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Content Box 01 Icon Size
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-9-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Content Box Title Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-9-title' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Title Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-9-title',
            ]
        );
    ...
    // Content Box Description Color
        $this->add_control(
            ...
            [
                ...
                // 'default' => '#6a4bc4',
                'selectors' => [
                    '{{WRAPPER}} .content-box-9-content' => 'color: {{VALUE}}',
                ],
            ]
        );
    // Content Box Description Typography
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .content-box-9-content',
            ]
        );
    ...
    // Box Background Section
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-8' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    
    // Box Hover Button Animation
        $this->add_control(
            'box_content_button_background',
            [
                'label' => esc_html__( 'Animation Border Color', 'textdomain' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content-box-8::before' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    // Box Margin Section
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .content-box-5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Padding Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    // Box Border Radius Section
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .content-box-5' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    // Box Shadow
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'selector' => '{{WRAPPER}} .content-box-5',
            ]
        );
 ...
 <div class="content-box-9">
            <div class="content-box-9-icon">
                <i class="<?php echo $content_box_icon ['value'];?>"></i>
            </div>
            <div class="content-box-9-content-wrapper">
                <h3 class="content-box-9-title"><?php echo $content_box_title; ?></h3>
                <div class="content-box-9-content"><?php echo $content_box_description; ?></div>
            </div>
            <a class="content-box-9-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
        <!-- END Content Box 9 -->
