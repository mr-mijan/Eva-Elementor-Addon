<?php
class Eva_Content_Box_20 extends \Elementor\Widget_Base
{

	public function get_name()
	{
		return 'contentbox_20';
	}

	public function get_title()
	{
		return esc_html__('Content Box 20', 'eva');
	}
 ...
 <!-- Start Content Box -->
 <div class="content-box-20">
            <div class="content-box-20-icon">
                <i class="<?php echo $content_box_icon ['value'];?>"></i>
            </div>
            <div class="content-box-20-content-wrapper">
                <h3 class="content-box-20-title"><?php echo $content_box_title; ?></h3>
                <div class="content-box-20-content"><?php echo $content_box_description; ?></div>
            </div>
            <a class="content-box-20-button" href="<?php echo $content_box_button_url['url']; ?>"><?php echo $content_box_button_text; ?></a>
        </div>
        <!-- End Content Box -->
